...
export const profile = {
  ...
  positioning: {
    position: 'AI 서비스 개발자',
    statement: 'Python·Flask/FastAPI 기반 AI 백엔드 · Computer Vision 서비스 개발',
  },
  /** 이력서 상단 요약 — 채용 담당자가 1분 안에 훑을 수 있도록 압축한 핵심 문장 */
  resumeSummary: [
    '온라인 마케팅·운영 5년 8개월 경력 후 AI 개발자로 전환, YOLO 탐지 결과를 API·DB·웹 화면으로 연결한 경험',
    'Python, Flask, FastAPI, MySQL, Next.js 기반 AI 서비스 MVP 구현 경험',
    '근무 조건 협의 시 AI 심화반 교육 기간 중에도 즉시 입사 가능',
  ],
  availability: '근무 조건 협의 시 즉시 입사 가능',
  coreCompetencies: [
  ...
  education: [
    { title: '학점은행제 컴퓨터공학 전공', period: '2020.06 ~ 2026.08.26 · 컴퓨터공학 전공 수료', description: '자료구조, 알고리즘, 운영체제, 데이터베이스, Python 프로그래밍, 데이터 처리, 머신러닝 이론 및 모델 구현을 학습했습니다.' },
    ...
    { title: 'AI 심화반 · Roboflow 기반 부유물 탐지 시스템 구축 과정', period: '2026.07.09 ~ 2026.09.09 · 진행 중', description: 'Roboflow를 활용한 데이터셋 구축과 모델 학습으로 부유물(하천·해양 등) 탐지 시스템을 구축하는 과정을 심화 학습합니다.' },
  ],
  workExperience: [
    {
      ...
      takeaway: '반복적인 운영 업무와 데이터 관리를 경험하며 업무 자동화와 데이터 기반 의사결정의 필요성을 인식했습니다.',
    },
    {
    ...
    },
    {
      ...
      takeaway: '상품 데이터 관리와 광고 운영 경험을 바탕으로 AI와 자동화 기술로 실제 업무 문제를 해결하는 개발자로 전환을 준비하게 되었습니다.',
    },
  ],
  skills: {
