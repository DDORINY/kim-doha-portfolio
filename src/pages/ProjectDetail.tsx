    ...
    <article className="detail-page" style={{ '--accent': project.accent } as React.CSSProperties}>
      ...
      <div className="container detail-layout">
        ...
        <div className="detail-content">
          <section id="overview" className="detail-section"><span className="section-number">{num('overview')} / OVERVIEW</span><h2>프로젝트 개요</h2>{project.teamNote && <span className="team-note">{project.teamNote}</span>}<p className="lead-copy">{project.summary}</p></section>
