...
const sectionLinks = [
  ['OVERVIEW & STATUS', 'overview'], ['PIPELINE', 'pipeline'], ['ARCHITECTURE', 'architecture'],
  ['BUILD & VALIDATION', 'build-validation'], ['ROADMAP & EVIDENCE', 'roadmap-evidence'],
] as const
...
export default function LLM() {
  return (
    <div className="llm-page">
      ...
      <div className="section llm-status-section" id="status" aria-labelledby="llm-status-title">
        <div className="container">
          <SectionHeading id="llm-status-title" eyebrow="01B / DEVELOPMENT STATUS" title="CURRENT DEVELOPMENT STATUS" description="완료율 대신 코드·테스트·실행 Evidence가 확인된 범위만 VERIFIED로 구분합니다." />
      ...
      <section className="section" id="pipeline" aria-labelledby="llm-pipeline-title">
        <div className="container">
          <SectionHeading id="llm-pipeline-title" eyebrow="02 / END-TO-END PIPELINE" title="END-TO-END LLM PIPELINE" description="현재 검증된 흐름과 이후 계획을 같은 Pipeline 안에서 숨김없이 분리합니다." />
      ...
      <section className="section llm-architecture-section" id="architecture" aria-labelledby="llm-architecture-title">
        <div className="container">
          <SectionHeading id="llm-architecture-title" eyebrow="03 / MODEL ARCHITECTURE" title="DOHALM-TINY ARCHITECTURE" description="승인된 Tiny 설정과 실제 모델 코드의 파라미터 계산 결과를 대조했습니다." />
      ...
      <section className="section" id="build-validation" aria-labelledby="llm-implementation-title">
        <div className="container">
          <SectionHeading id="llm-implementation-title" eyebrow="04A / IMPLEMENTATION" title="TOKENIZER & MODEL IMPLEMENTATION" description="운영 Tokenizer Bundle과 PyTorch 모델 모듈을 구현·검증 항목 중심으로 정리했습니다." />
      ...
      <div className="section llm-training-section" id="training" aria-labelledby="llm-training-title">
        <div className="container">
          <SectionHeading id="llm-training-title" eyebrow="04B / TRAINING SYSTEM" title="TRAINING ON A SINGLE 8GB GPU" description="고성능 장비를 가정하지 않고 RTX 3060 Ti 8GB 안에서 실행 가능한 모델과 학습 범위를 측정하며 설계했습니다." />
      ...
      <div className="section" id="quality" aria-labelledby="llm-quality-title">
        <div className="container">
          <SectionHeading id="llm-quality-title" eyebrow="04C / QUALITY GATES" title="QUALITY GATE DEVELOPMENT" description="설계 문서, 코드, 자동화 테스트와 실행 결과를 함께 검토한 뒤 다음 단계로 이동합니다." />
      ...
      <section className="section llm-roadmap-section" id="roadmap-evidence" aria-labelledby="llm-roadmap-title">
        <div className="container">
          <SectionHeading id="llm-roadmap-title" eyebrow="05A / GOVERNANCE & ROADMAP" title="DATA GOVERNANCE & NEXT GATES" description="사용 가능한 데이터 범위와 아직 승인되지 않은 다음 단계를 분리해 관리합니다." />
      ...
      <div className="section llm-documents-section" id="documents" aria-labelledby="llm-documents-title">
        <div className="container">
          <SectionHeading id="llm-documents-title" eyebrow="05B / REPOSITORY & DOCUMENTS" title="DOCUMENTED BY DESIGN" description="설계 승인과 구현 완료를 구분하고, 결정과 검증 결과를 실제 저장소 문서로 추적합니다." />
